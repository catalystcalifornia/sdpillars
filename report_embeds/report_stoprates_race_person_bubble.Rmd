...
chart <- fx_bubblepopchart(
  ...
  tooltip_text="For every 1K <b>{point.race_label_short:.1f}</b> people in San Diego, SDPD stopped <b>{point.stop_per1k_rate:.1f}</b> people perceived as <b>{point.race_label_short:.1f}</b>, a total of <b>{point.stop_count:,0f}</b> people.", # customize your tooltip as a statement, calling out rate and count
