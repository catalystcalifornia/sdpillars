...
chart <- fx_bubblepopchart(
  ...
  y='stop_per1k_rate', 
  z='stop_count',
  top_finding=paste0("SDPD stop Black and NHPI people at higher rates than other community members"), 
  subtitle= paste0("Number of people who are stopped during officer-initiated stops per 1K people of the same race"), 
  tooltip_text="For every 1K <b>{point.race_label_short:.1f}</b> people in San Diego, SDPD stopped <b>{point.stop_per1k_rate:.1f}</b> people perceived as <b>{point.race_label_short:.1f}</b>, for a total of <b>{point.stop_count:,0f}</b> people.", # customize your tooltip as a statement, calling out rate and count
