...
fx_bubblepopchart <- function(
  ...
  highchart() %>%
    ...
    hc_legend(title=list(text=paste0('<span style="color: #000000; font-weight: 400; font-size:10px;">Length of line shows the rate of people stopped | The bubble shows the number of people stopped</span><br/>')),
              enable = TRUE,
              # width = '15%',
              align = "center", 
              verticalAlign="top",
