...
# TOOLTIP
tooltip_text <- "Out of 1,000 <b>{point.race_label_short:.0f}</b> people in San Diego, SDPD stopped <b>{point.rate:.1f}</b> people perceived as <b>{point.race_label_short:.0f}</b> for an officer-initiated stop that resulted in a field interview card"
