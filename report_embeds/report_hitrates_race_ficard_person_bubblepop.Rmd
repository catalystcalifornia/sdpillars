...
chart <- fx_bubblepopchart(
  ...
  z='stop_count',
  top_finding=paste0("In searches SDPD officers choose to conduct during field interview cards, most yield no contraband and disproportionately target people of color."), # this is the top finding from the chart that gets used like a title
  subtitle= paste0("Rate of searches with no contraband or evidence found during field interview cards by race"), # this is the more standard chart title that gets used as a subtitle
