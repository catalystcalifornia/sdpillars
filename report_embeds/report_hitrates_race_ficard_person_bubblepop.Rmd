...
chart <- fx_bubblepopchart(
  ...
  z='stop_count',
  top_finding=paste0("Most searches SDPD conducts during field interview cards yield no contraband and disproportionately target people of color."), # this is the top finding from the chart that gets used like a title
