...
tooltip_text <- "Across all people perceived as <b>{point.race_label_short:.1f}</b> who had a field interview card completed, officers used <b>{point.reason_simple:.1f}s</b> as the primary reason for the stop <b>{point.rate:.1f}%</b> of the time."
...
subtitle_text<-paste0("Percent of people who were field interviewed and originally stopped for traffic violations by race")
    
caption_text <- paste0(sourcenote,"<br>", racenote, "<br>","Analysis for all officer-initiated stops that only resulted in a field interview card completed.","<br>")
...
chart <- fx_bubblepopchart(
  ...
  export_data_label=list(pointFormat='{point.rate:.1f}%') # format for your data
)
