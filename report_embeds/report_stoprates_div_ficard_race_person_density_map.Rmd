...
rate_popup <- "<div class='leaflet-popup-scrolled'><div class='popup-instruction'>Please click on a San Diego police division to see stop data below.<br></div><div class ='division-header'><span class='division-name'></span> Division (Division <span class='division-number'></span>)</div><div class='division-subheader'>SDPD Officers conducted field interviews on:</div>
<ul class='popup-list'>
