...
```{r, include = FALSE}
rate_popup <- paste0(label = paste0(
...
map <-  leaflet(width = "100%", height = "600px") %>%
  ...
  addLayersControl(overlayGroups = c("AIAN",  "NHPI", "SWANA/SA", "Asian",  "Black", "Latinx", "Two or More Races", "White"), options = layersControlOptions(collapsed = FALSE)) %>%
    
  ### add Legend
  addLegend("bottomleft", title= paste0("1 dot = 5 field interview card stops"), 
            colors = colors_function(colors = c(dark_tangerine, halaya_ube, american_yellow, halloween_orange, blue,lime_green, persian_indigo, bitter_lemon), sizes = "10", shapes = "circle", borders = NULL),
