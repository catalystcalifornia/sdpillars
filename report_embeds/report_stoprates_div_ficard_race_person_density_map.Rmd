...
rate_popup <- "<div class='leaflet-popup-scrolled point-density-sidebar'><div class='popup-instruction'>Please click on a San Diego police division to see stop data below.</div><div class ='division-header'><span class='division-name'></span> Division (Division <span class='division-number'></span>)</div></div>SDPD Officers conducted field interviews on:<br><ul class='popup-list'>
...
<li class='popup-list-item'><span class='data-emphasis nh-twoormor-color'><span class='count-nh-twoormor nh-twoormor-color'></span> people</span> they perceived as <span class='data-emphasis nh-twoormor-color'>Multiracial</span>, or <span class='rate-nh-twoormor data-emphasis nh-twoormor-color'></span>% of Multiracial people they stopped.</span></li> 
<li class='popup-list-item'><span class='nh-white-color'><span class='data-emphasis count-nh-white nh-white-color'></span> people</span> they perceived as <span class='data-emphasis nh-white-color'>White</span>, or <span class='rate-nh-white data-emphasis nh-white-color'></span>%</span> of White people they stopped.</li></ul> "
