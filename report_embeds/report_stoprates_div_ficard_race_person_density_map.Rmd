...
data_popup <- paste0("<div class='pd1'> <div class='leaflet-data-pd1' data-pd1-division-name='", div_wide_sf$div_name,
...
L.Map.addInitHook(function () {
  ...
  mapsPlaceholder.forEach(map => {
    ...
    map.on('popupopen', (e) => {
    let popups = document.querySelectorAll('.leaflet-data-pd1');
    // console.log(popups);

    document.querySelectorAll('.pd1').forEach(pointdensity => {
  ...
  document.querySelector('.pd1-division-name').innerHTML = popup.getAttribute('data-pd1-division-name')
  document.querySelector('.pd1-division-number').innerHTML = popup.getAttribute('data-pd1-division-number')
