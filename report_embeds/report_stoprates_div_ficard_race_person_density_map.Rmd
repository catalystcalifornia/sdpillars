...
L.Map.addInitHook(function () {
  ...
  mapsPlaceholder.forEach(map => {
    ...
    document.querySelector('.count-nh-black').innerHTML = ''
    document.querySelector('.rate-nh-black').innerHTML = ''
    document.querySelector('.count-latinx').innerHTML = ''
    document.querySelector('.rate-latinx').innerHTML = ''
    document.querySelector('.count-nh-asian').innerHTML = ''
    document.querySelector('.rate-nh-asian').innerHTML = ''
    document.querySelector('.count-nh-nhpi').innerHTML = ''
    document.querySelector('.rate-nh-nhpi').innerHTML = ''
    document.querySelector('.count-sswana').innerHTML = ''
    document.querySelector('.rate-sswana').innerHTML = ''
    document.querySelector('.count-nh-twoormor').innerHTML = ''
    document.querySelector('.rate-nh-twoormor').innerHTML = ''
    document.querySelector('.count-nh-white').innerHTML = ''
    document.querySelector('.rate-nh-white').innerHTML = ''
    }, 250)
  })
  ...
  document.querySelector('.count-nh-white').innerHTML = popup.getAttribute('data-cout-nh-white')
