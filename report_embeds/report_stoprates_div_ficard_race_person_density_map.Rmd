...
rate_popup <- "<div class='leaflet-popup-scrolled point-density-sidebar'><div class='popup-instruction'>Please click on a police division to see stop data below.</div><div class ='division-header'><span class='division-name'></span> Division (Division <span class='division-number'></span>)</div></div><br> SDPD Officers stopped:<br><br>
<span class='count-nh-black'></span> people perceived as <span class='data-emphasis'>Black</span> for stops that resulted in a field interview card completed, or<span class='rate-nh-black'></span>% of Black people stopped.<br><br> 
<span class='count-latinx'></span> people perceived as <span class='data-emphasis'>Latinx</span> for stops that resulted in a field interview card completed, or<span class='rate-latinx'></span>% of Latinx people stopped.<br><br> 
<span class='count-nh-asian'></span> people perceived as <span class='data-emphasis'>Asian</span> for stops that resulted in a field interview card completed, or<span class='rate-nh-asian'></span>% of Asian people stopped.<br><br> 
<span class='count-nh-aian'></span> people perceived as <span class='data-emphasis'>AIAN</span> for stops that resulted in a field interview card completed, or<span class='rate-nh-aian'></span>% of AIAN people stopped.<br><br> 
<span class='count-nh-nhpi'></span> people perceived as <span class='data-emphasis'>NHPI</span> for stops that resulted in a field interview card completed, or<span class='rate-nh-nhpi'></span>% of NHPI people stopped.<br><br> 
<span class='count-sswana'></span> people perceived as <span class='data-emphasis'>SWANA/SA</span> for stops that resulted in a field interview card completed, or<span class='rate-sswana'></span>% of SWANA/SA people stopped.<br><br> 
<span class='count-nh-twoormor'></span> people perceived as <span class='data-emphasis'>Multiracial</span> for stops that resulted in a field interview card completed, or<span class='rate-nh-twoormor'></span>% of Multiracial people stopped.<br><br> 
<span class='count-nh-white'></span> people perceived as <span class='data-emphasis'>White</span> for stops that resulted in a field interview card completed, or<span class='rate-nh-white'></span>% of White people stopped.<br><br> "
