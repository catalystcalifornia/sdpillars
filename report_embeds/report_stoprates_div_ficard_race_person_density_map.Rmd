...
rate_popup <- "<div class='leaflet-popup-scrolled'><div class='popup-instruction'>Please click on a San Diego police division to see stop data below.</div><div class ='division-header'><span class='division-name'></span> Division (Division <span class='division-number'></span>)</div>SDPD Officers conducted field interviews on:<br><ul class='popup-list'>
...
<li class='popup-list-item'><span class='nh-white-color'><span class='data-emphasis count-nh-white nh-white-color'></span> people</span> they perceived as <span class='data-emphasis nh-white-color'>White</span>, or <span class='rate-nh-white data-emphasis nh-white-color'></span>%</span> of White people they stopped.</li></ul></div>"
