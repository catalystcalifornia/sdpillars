...
text <- "Across all people between the <b>ages of {point.age_bracket:.1f}</b> stopped by officers assigned to the gang enforcement assignment, officers stopped <b>{point.race_label_short:.1f}</b> people <b>{point.rate:.1f}% of the time</b>. <b>{point.race_label_short:.1f}</b> people <b>{point.age_bracket:.1f}</b> years old make up <b>{point.pop_rate:.1f}%</b> of the population in San Diego."
...
chart<-hchart(df, 
    ...
    hc_subtitle(
      text = "Percent of stops made by officers assigned to gang enforcement by race and age") %>%
