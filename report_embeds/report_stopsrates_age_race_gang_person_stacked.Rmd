...
text <- "Across all people between the <b> ages of {point.age_bracket:.1f}</b> stopped by officers assigned to the gang enforcement assignment, officers stopped <b>{point.race_label_short:.1f} people {point.rate:.1f}% of the time.</b>"
