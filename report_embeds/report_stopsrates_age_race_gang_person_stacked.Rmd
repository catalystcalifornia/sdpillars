...
age_levels<-c("18 and under","19-24","25-34","35-44","45-54", "55-64", "65 and older")
age_labels<-c("18 and under","19-24","25-34","35-44","45-54", "55-64", "65 and older")
df$age_bracket<-factor(df$age_bracket, ordered=TRUE, 
                                               levels=age_levels, labels=age_labels)


text <- "Across all officer-initiated stops made by SDPD Gang Enforcement assignment of folks <b> ages {point.age_bracket:.1f}</b>, officers assigned to gang enforcement stopped <b>{point.race_label_short:.1f} people {point.rate:.1f}% of the time.</b>"
...
chart<-hchart(df, 
    ...
    hc_title(
      text = "Officers assigned to Gang Enforcement stop Black and Latinx youth at disproportionately high rates") %>%
    
    hc_subtitle(
      text = "Percent of officer-initiated stops made by officers assigned to Gang Enforcement for every race across age groups") %>%
    ...
    hc_xAxis( categories=list("18 and under","19-24","25-34","35-44","45-54", "55-64", "65 and older"),
              title = list(text = paste0(""),
