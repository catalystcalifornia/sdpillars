...
mutate(across(where(is.numeric), ~round(., 1)))%>%
  mutate(tooltip=ifelse(race %in% "nh_sswana", "",  paste0("By comparison, <b>",race_label_short, " people</b> make up <b>",pop_rate,"%</b><br>of the population ages <b>",age_bracket,"</b> in San Diego.")))


text <- "Across all people aged <b>{point.age_bracket:.1f}</b> stopped by officers assigned to<br>gang enforcement, officers stopped people perceived as <b>{point.race_label_short:.1f}</b><br><b>{point.rate:.1f}% of the time</b>. {point.tooltip}"
