...
tooltip_text <- "Across all officer-initiated stops of folks <b> ages {point.age_bracket:.1f} </b>, SDPD stopped <b>{point.race:.1f} people {point.rate:.1f}% of the time.</b>"
...
chart <- fx_stackedbarchart(  
  ...
  group_colors = c(meteorite, lavender, orange, peridot, ccblue, gainsboro, "#211447",
                         "#FF9E0D", "#A8683C"),
  top_finding = 'SDPD stops young Latinx people at disproportionately high rates',
  subtitle = 'Stop rates for officer-initiated stops for every race across age groups',
