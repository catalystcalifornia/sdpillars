...
df<-df%>%
  ...
  filter(race!='nh_sswana' & race !="nhpi" & race != 'aian')%>%
mutate(across(where(is.numeric), ~round(., 1)))%>%
  mutate(tooltip=ifelse(race %in% "sswana", "",  paste0("By comparison, <b>",race_label_short, " people</b> make up <b>",pop_rate,"%</b> of the population ages <b>",age_bracket,"</b> in San Diego.")))
