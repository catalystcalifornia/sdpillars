...
tooltip_text <- "For every 100 <b>{point.race_label_short:.1f}</b> people stopped by SDPD, officers stopped <b>{point.rate:.1f}</b> people they perceived as <b>{point.race_label_short:.1f}</b> for stops that only resulted in <b>{point.result_simple:.1f}</b>, for a total of <b>{point.count:,0f}</b> people."
