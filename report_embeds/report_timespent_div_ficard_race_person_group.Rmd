...
tooltip_text<- paste0("Out of all hours spent on <b>officer-initiated stops resulting in a field interview card</b> in the <b>{point.div_name} Division (Division {point.div})</b>, SDPD spent <b>{point.duration_rate:.1f}%</b> of those hours conducting field interviews on people perceived as <b>Black</b>. By comparison, <b>Black people</b> make up just <b>{point.pop_rate:.1f}%</b> of the total population in the <b>{point.div_name} Division</b>")
