...
chart <- fx_bubblepopchart(
  ...
  tooltip_text="Out of <b>{point.stop_total_count:.1f}</b> people stopped by officers assigned to gang enforcement, SDPD stopped <b>{point.stop_count:.1f}</b> people perceived as <b>{point.race_label_short:.1f}</b>, or <b>{point.stop_prc_rate:.1f}</b>% of all people stopped.", # customize your tooltip as a statement, calling out rate and count
