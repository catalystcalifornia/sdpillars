...
df %>%
  hchart(
    ...
    name = "",
    tooltip = list(headerFormat="", pointFormat = "<b>{point.rate:.1f}%</b> of people searched by SDPD had <b>{point.label}</b>, a total of <b>{point.count:,.0f}</b>  people."),
     innerSize="65%",
     center = c(50, 50), 
    )%>% 
  hc_title(text = "Most searches conducted by SDPD yield no evidence or contraband.",
 align="left")%>%
   hc_subtitle(text = "Percentage of searches by whether contraband or evidence was found",
                     align="left") %>%
  hc_caption(
