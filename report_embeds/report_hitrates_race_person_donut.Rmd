...
df %>%
  hchart(
    ...
    name = "",
    tooltip = list(headerFormat="", pointFormat = "<b>{point.rate:.1f}%</b> of people SDPD searched had <b>{point.label}</b>, for a total of <b>{point.count:,.0f}</b>  people needlessly searched."),
     innerSize="65%",
     center = c(50, 50), 
    )%>% 
