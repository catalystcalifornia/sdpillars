...
map <- leaflet(width = "100%", height = "600px",
  ...
  # add polygons first - if the fillColor is white and it is added below/after markers, the marker colors will get washed out (dull)
  addPolygons(data = div_wide_sf, label=~htmlEscape(paste0(div_name, " Division ")),
              ...
              weight = 2, smoothFactor = 0.5, highlight = highlightOptions(color = "white", 
                                                                           weight = 3, 
                                                                           # Use these settings otherwise highlight will change marker colors
