...
data_popup <- paste0("<div class='pd2'> <div class='leaflet-data-pd2' data-pd2-division-name='", div_wide_sf$div_name,
...
L.Map.addInitHook(function () {
  ...
  mapsPlaceholder.forEach(map => {
    ...
    map.on('popupopen', (e) => {
    let popups = document.querySelectorAll('.leaflet-data-pd2');
    // console.log(popups);

    document.querySelectorAll('.pd2').forEach(pointdensity => {
  ...
  document.querySelector('.pd2-division-name').innerHTML = popup.getAttribute('data-pd2-division-name')
  document.querySelector('.pd2-division-number').innerHTML = popup.getAttribute('data-pd2-division-number')
