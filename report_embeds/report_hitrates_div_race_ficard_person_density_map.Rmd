...
rate_popup <- "<div class='leaflet-popup-scrolled point-density-sidebar'><div class='popup-instruction'>Please click on a police division to see stop data below.</div><div class ='division-header'><span class='division-name'></span> Division (Division <span class='division-number'></span>)</div></div><br>Out of <span class='stop-count-total data-emphasis'></span> people searched during stops where a field interview card was completed:<br><br>SDPD found contraband/evidence on <span class='yes-contraband-count data-emphasis'></span> people, a hit rate of <span class='yes-contraband-prc-rate data-emphasis'></span>%.<br><br>SDPD found no contraband or evidence on <span class='no-contraband-count data-emphasis'></span> people, meaning SDPD  subjected <span class='no-contraband-prc-rate data-emphasis'></span>% of people to unnecessary searches.
