...
Out of <span class='stop-count-total' style='font-size: 14px; font-weight: bold;'></span> people searched during stops where a field interview card was completed, SDPD found contraband/evidence on <span class='contraband-count' style='font-size: 14px; font-weight: bold;'></span> people, a hit rate of <span class='contraband-prc-rate' style='font-size: 14px; font-weight: bold;'></span>%.

<br>

SDPD found no contraband or evidence on <span class='no-contraband-count-total' style='font-size: 14px; font-weight: bold;'></span> people, meaning SDPD  subjected <span class='no-contrband-prc-rate-total' style='font-size: 14px; font-weight: bold;'></span>% of people to unnecessary searches.
</div>"
...
division = popup.getAttribute('data-division-name')
document.querySelectorAll('.division-name').forEach(node => node.innerHTML = division)
