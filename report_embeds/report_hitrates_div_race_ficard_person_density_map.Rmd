...
map <-  leaflet(width = "100%", height = "600px") %>%
  ...
  addCircleMarkers(data = contraband_dots, group = "Yes Contraband Found", label = NULL, weight = 3, fillOpacity = 1, radius = 2, color="white",  fillColor=  peridot,  stroke = TRUE) %>% 
  
  ## add no contraband stops
  
  addCircleMarkers(data = no_contraband_dots, group = "No Contraband Found", label = NULL, weight = 3, fillOpacity = 1, radius = 2, color="white",  fillColor= meteorite, stroke = TRUE) %>% 
