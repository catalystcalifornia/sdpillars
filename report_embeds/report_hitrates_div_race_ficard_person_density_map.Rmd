...
```{r, include=FALSE}
rate_popup <- paste0(label = paste0("<div class='leaflet-popup-scrolled' style='max-width:800px;max-height:200px'>",
                   ...
                   "<span style='font-size: 14px; font-weight: bold;'>", div_wide_sf$contraband_count, "</span>", 
                   " people, a hit rate of ", "<span style='font-size: 14px; font-weight: bold;'>", 
