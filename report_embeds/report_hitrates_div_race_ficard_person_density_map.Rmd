...
rate_popup <- "<div class='leaflet-popup-scrolled'><div class='popup-instruction'>Please click on a San Diego police division to see stop data below.</div><div class ='division-header'><span class='division-name'></span> Division (Division <span class='division-number'></span>)</div>
<br>
...
<br><br>
<div class='legend'><div class='legend-note'>1 dot = 5 field interview card stops and a search</div><br><span class='no-contraband-dot'></span> No Contraband Found <br><span class='yes-contraband-dot'></span> Yes Contraband Found</div></div></div><br>"
