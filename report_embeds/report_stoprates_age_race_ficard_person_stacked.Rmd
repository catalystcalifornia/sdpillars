...
mutate(across(where(is.numeric), ~round(., 1)))%>%
  mutate(tooltip=ifelse(race %in% "nh_sswana", "",  paste0("By comparison, <b>",race_label_short, " people</b> made up <b>",pop_rate,"%</b> of the population aged <b>",age_bracket,"</b> in San Diego.")))
                        

# set tooltip

text<-"Across all field interviews of people aged <b>{point.age_bracket:.1f}</b>, SDPD stopped people perceived as <b>{point.race_label_short:.1f} {point.rate:.1f}% of the time.</b> {point.tooltip}"
...
group_colors <- c(meteorite, papaya, peridot, lavender, ccblue, "#5F3B63","#A8683C", "#D58424", "#FF9900")
